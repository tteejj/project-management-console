...
# Preload integrated FakeTUI classes and components so class definitions exist
try {
    # Core classes
    . $PSScriptRoot/FakeTUI/Core/PerformanceCore.ps1
    . $PSScriptRoot/FakeTUI/Core/SimpleTerminal.ps1
    # UI components and integration bridge
    . $PSScriptRoot/FakeTUI/Components/MenuSystem.ps1
    . $PSScriptRoot/FakeTUI/Integration/CLIAdapter.ps1
    # Screens and dialogs
    . $PSScriptRoot/FakeTUI/Screens/TaskListScreen.ps1
    . $PSScriptRoot/FakeTUI/Screens/ProjectListScreen.ps1
    . $PSScriptRoot/FakeTUI/Components/TaskEditDialog.ps1
    . $PSScriptRoot/FakeTUI/Components/CommandPalette.ps1
    # App class definition
    . $PSScriptRoot/FakeTUI/FakeTUIAppIntegrated.ps1
    Write-Host "  ✓ Integrated FakeTUI classes preloaded" -ForegroundColor Green
} catch {
    Write-Host "  ✗ Integrated FakeTUI preload failed: $_" -ForegroundColor Red
    throw
}
