...
# Load required components - load Core classes FIRST
...
. $PSScriptRoot/Components/TaskEditDialog.ps1
. $PSScriptRoot/Components/CommandPalette.ps1
...
# Export the integrated application
