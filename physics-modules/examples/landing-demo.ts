...
const reactorTemp = finalState.thermal.components.find((c: any) => c.name === 'reactor')?.temperature || 0;
const engineTemp = finalState.thermal.components.find((c: any) => c.name === 'main_engine')?.temperature || 0;
