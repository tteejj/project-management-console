...
exports.ElectricalSystem = void 0;
class ElectricalSystem {
    constructor(config) {
        // Tracking for analysis
        this.totalPowerGenerated = 0; // kWh
        this.totalPowerConsumed = 0; // kWh
        this.events = [];
    ...
    managePowerBalance(dt, time) {
        ...
        if (netPowerKW < 0) {
            ...
            this.battery.chargeKWh = Math.min(this.battery.capacityKWh, this.battery.chargeKWh + batteryChargeKWh);
...
exports.ElectricalSystem = ElectricalSystem;
//# sourceMappingURL=electrical-system.js.map