...
exports.ThermalBudgetSystem = exports.CoolingType = void 0;
var CoolingType;
(function (CoolingType) {
    CoolingType["LIQUID_LOOP"] = "liquid_loop";
    CoolingType["RADIATOR"] = "radiator";
    CoolingType["HEAT_PIPE"] = "heat_pipe";
    CoolingType["THERMOELECTRIC"] = "thermoelectric";
})(CoolingType || (exports.CoolingType = CoolingType = {}));
/**
 * Thermal Budget System
 */
class ThermalBudgetSystem {
    constructor(config) {
        this.components = new Map();
        this.compartments = new Map();
        this.coolingSystems = new Map();
        // Statistics
        this.totalHeatGenerated = 0;
        this.totalHeatRejected = 0;
        // Constants
        this.STEFAN_BOLTZMANN = 5.67e-8; // W/(m²·K⁴)
        this.AIR_SPECIFIC_HEAT = 1005; // J/(kg·K)
        this.CONVECTION_COEFF = 10; // W/(m²·K) typical for natural convection
        this.CONDUCTION_COEFF = 0.5; // Simplified inter-compartment heat transfer
     ...
     * Add cooling system
     */
    addCoolingSystem(cooling) {
        this.coolingSystems.set(cooling.id, cooling);
    }
}
exports.ThermalBudgetSystem = ThermalBudgetSystem;
//# sourceMappingURL=thermal-budget.js.map