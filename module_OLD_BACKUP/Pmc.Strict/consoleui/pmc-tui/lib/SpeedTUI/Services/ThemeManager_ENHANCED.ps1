...
class SimpleTheme {
    ...
    <#
    .SYNOPSIS
    Define a color using ANSI sequences
...
Export-ModuleMember -Function Get-ThemeManager, Set-SpeedTUITheme, Get-SpeedTUIColor, New-SpeedTUITheme, Show-SpeedTUITheme